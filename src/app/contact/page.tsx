...
const Contact = () => {
  ...
  return (
    <div className="flex items-center p-12 bg-[#F6838D] bg-custom-bg bg-custom-bg-size bg-custom-bg-position bg-no-repeat h-screen-minus-header">
      <div className="w-1/2">
        <div className="relative">
          ...
          <h1 className="font-headline text-6xl text-white realistic-marker-highlight relative z-0 w-fit">
            Contactez-nous
          </h1>
          <Image
            src="/arrow2.png"
            ...
            width={180}
            height={90}
            className="rotate-[20deg] mr-8 absolute right-[-1rem] bottom-[-6rem]"
          />
        </div>

        <div className="pt-16 grid gap-4 w-4/5 text-white">
          <p>
            Taciti hendrerit torquent lobortis montes nostra cubilia gravida
            faucibus nascetur. Mus praesent tempus semper suscipit dui habitasse
            neque.
          </p>
          <div className="flex justify-between">
            ...
            <Image
              ...
              width={250}
              height={125}
              className="drop-shadow-lg rotate-[-10deg] mr-8"
              priority
            />
          </div>
        </div>
      ...
      <div className="w-1/2 grid content-center shadow-md rounded-3xl">
        <form
          className="flex flex-col gap-4 bg-white rounded-3xl p-8"
